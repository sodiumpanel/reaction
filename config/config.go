...
const DefaultLocation = "/etc/sodium/config.yml"
...
type SystemConfiguration struct {
	// The root directory where all of the sodium data is stored at.
	RootDirectory string `default:"/var/sodium" json:"-" yaml:"root_directory"`

	// Directory where logs for server installations and other wings events are logged.
	LogDirectory string `default:"/var/sodium/logs" json:"-" yaml:"log_directory"`

	// Directory where the server data is stored at.
	Data string `default:"/var/sodium/volumes" json:"-" yaml:"data"`

	// Directory where server archives for transferring will be stored.
	ArchiveDirectory string `default:"/var/sodium/archives" json:"-" yaml:"archive_directory"`

	// Directory where local backups will be stored on the machine.
	BackupDirectory string `default:"/var/sodium/backups" json:"-" yaml:"backup_directory"`

	// TmpDirectory specifies where temporary files for Sodium installation processes
	// should be created. This supports environments running docker-in-docker.
	TmpDirectory string `default:"/tmp/sodium" json:"-" yaml:"tmp_directory"`

	// The user that should own all of the server files, and be used for containers.
	Username string `default:"sodium" yaml:"username"`
...
type Configuration struct {
	...
	AppName string `default:"Sodium" json:"app_name" yaml:"app_name"`
