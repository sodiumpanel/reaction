...
const (
	...
	DecompressProgressEvent      = "decompress progress"
	DecompressCompletedEvent     = "decompress completed"
	CompressProgressEvent        = "compress progress"
	CompressCompletedEvent       = "compress completed"
)
